...
public class Transaccion implements java.io.Serializable {
	...
	private java.lang.Boolean existeCuenta = false;
	...
	private java.lang.Boolean existeLog = false;
	...
	public void setDiffValues(){
	    System.out.println("Valores a restar valorLog: " + this.valorLog + " valorCuenta: " + this.valorCuenta);
	    this.valor = Math.abs(this.valorCuenta - this.valorLog);
	    System.out.println("Valor calculado: " + this.valor);
	}
